...
namespace PersonelTakip
{
    public partial class Form3 : Form
    {
        ...
        OleDbConnection baglantim = new OleDbConnection("Provider = Microsoft.Jet.OLEDB.4.0; Data Source = D:\\Kisiler.mdb");
        ...
        private void personelleri_goster()
        {
            ...
            catch (Exception hatamsj)
            {
                ...
                MessageBox.Show(hatamsj.Message, "SKY PERSONEL TAKİP PROGRAMI", MessageBoxButtons.OK, MessageBoxIcon.Error);
                baglantim.Close();
            }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (maskedTextBox1.Text.Length == 11)
            {
                ...
                MessageBox.Show("11 HANELİ BİR TC KİMLİK NUMARASI GİRİNİZ");
